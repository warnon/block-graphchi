...
all: apps tests 
apps: example_apps/incremental_pagerank example_apps/simple_incremental_pagerank example_apps/partition_hash example_apps/partition_undirbfs example_apps/partition_bfs example_apps/sssp example_apps/connectedcomponents example_apps/pagerank example_apps/bfs example_apps/communitydetection example_apps/stronglyconnectedcomponents 

#apps: example_apps/core_decomp example_apps/connectedcomponents example_apps/connectedcomponents_ori  example_apps/pagerank example_apps/bfs_ori example_apps/bfs  example_apps/communitydetection example_apps/stronglyconnectedcomponents example_apps/pagerank 
# example_apps/trianglecounting example_apps/randomwalks example_apps/minimumspanningforest
